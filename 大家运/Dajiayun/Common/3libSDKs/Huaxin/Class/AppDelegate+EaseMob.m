...
//    if(canShow){
//        NewFeatureModel *m1 = [NewFeatureModel model:[UIImage imageNamed:@"dfzq_101401"]];
//        NewFeatureModel *m2 = [NewFeatureModel model:[UIImage imageNamed:@"dfzq_101402"]];
//        NewFeatureModel *m3 = [NewFeatureModel model:[UIImage imageNamed:@"dfzq_101403"]];
...
//    }
    self.window.rootViewController = [[LCPanNavigationController alloc] initWithRootViewController:self.mainController];
    [self.window.layer transitionWithAnimType:TransitionAnimTypeReveal subType:TransitionSubtypesFromBotoom curve:TransitionCurveDefault duration:1.f];
}
...
- (void)loginStateChange:(NSNotification *)notification
{
    ...
    if (isAutoLogin || loginSuccess) {//登陆成功加载主窗口控制器
        ...
        self.window.backgroundColor = [UIColor whiteColor];
        [self.window.layer transitionWithAnimType:TransitionAnimTypeReveal subType:TransitionSubtypesFromRight curve:TransitionCurveDefault duration:1.f];
    }
