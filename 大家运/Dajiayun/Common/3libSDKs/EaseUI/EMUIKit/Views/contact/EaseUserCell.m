...
//    }
    ...
    if (self.indexPath.section>=1) {
        ...
        member = [ContactsDao queryDataMember:[_model.nickname intValue]];
        ...
        [self getmemberInfoFrmoID:model Ids:_model.nickname];
    }
...
//*根据id获取会员信息*********************************************
- (void)getmemberInfoFrmoID:(id<IUserModel>)model Ids:(NSString *)Ids {
