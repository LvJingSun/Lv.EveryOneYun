...
@interface EaseMessageViewController ()<EaseMessageCellDelegate,TTTAttributedLabelDelegate>
{
...
//                        emcell.labelDelegate = self;
                       
                    }
                    emcell.bubbleView.textLabel.delegate = self;
                }
...
//            sendCell.labelDelegate = self;
            
        }
        
        sendCell.model = model;
        sendCell.bubbleView.textLabel.delegate = self;
        return sendCell;
    }
}
...
- (void)messageCellSelected:(id<IMessageModel>)model
{
    ...
    switch (model.bodyType) {
        ...
        case eMessageBodyType_Text:
        {
            ...
            if (_delegate && [_delegate respondsToSelector:@selector(messageViewControllerWithString:)]) {
                [_delegate messageViewControllerWithString:model.text];
