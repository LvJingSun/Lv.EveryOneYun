...
//            imageUnitView.imageView.image = [[UIImage alloc] fixOrientation];
...
//    _oneImageView.image = [[UIImage alloc] fixOrientation];
...
//        imageUnitView.imageView.image = [[UIImage alloc] fixOrientation];
        //缩略图显示格式，修改DFTime
        //*************************************************************//
        [imageUnitView.imageView setContentScaleFactor:[[UIScreen mainScreen] scale]];
        imageUnitView.imageView.contentMode =  UIViewContentModeScaleAspectFill;
        imageUnitView.imageView.autoresizingMask = UIViewAutoresizingFlexibleHeight;
