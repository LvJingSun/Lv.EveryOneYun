...
- (void)pan:(UIPanGestureRecognizer *)pan
{
    ...
    switch (state) {
        ...
        case UIGestureRecognizerStateChanged:{
            ...
            if (translationPoint.x > Windows_WIDTH) translationPoint.x = Windows_WIDTH;
            
            CGFloat k = translationPoint.x / Windows_WIDTH;
        ...
        case UIGestureRecognizerStateEnded:{
            ...
            [UIView animateWithDuration:0.3 animations:^{
                ...
                self.visibleViewController.view.transform = reset ? CGAffineTransformIdentity : CGAffineTransformTranslate(CGAffineTransformIdentity, Windows_WIDTH, 0);
...
- (BOOL)gestureRecognizerShouldBegin:(UIPanGestureRecognizer *)gestureRecognizer
{
    ...
    if (touchPoint.x < 0 || touchPoint.y < Windows_WIDTH/3 || touchPoint.x > Windows_WIDTH) return NO;
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    if (touchPoint.x < Windows_WIDTH/3) {
