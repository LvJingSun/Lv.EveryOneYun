...
static NSString *kNSDateHelperFormatSQLNO_Date          = @"yyyyMMdd";
static NSString *kNSDateHelperFormatSQLTime             = @"HH:mm:ss";
static NSString *kNSDateHelperFormatSQLTimeHM             = @"HH:mm";
static NSString *kNSDateHelperFormatSQLDateWithTime     = @"yyyy-MM-dd HH:mm:ss";
static NSString *kNSDateHelperFormatSQLDateWithTimeHM     = @"yyyy-MM-dd HH:mm";
static NSString *kNSDateHelperFormatSQLDateWithTimeXie     = @"yyyy/MM/dd HH:mm:ss";
