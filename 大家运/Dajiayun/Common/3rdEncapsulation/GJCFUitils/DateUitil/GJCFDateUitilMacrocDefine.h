...
/**
 *  天数间隔文本字符串(后面的还返回日期格式)
 */
#define GJCFDateStringDaysAgoForNormal(aDate) [GJCFDateUitil stringDaysAgoForNormal:aDate]
 ...
 *  @return 中文
 */
#define GJCFdateToStringByInteger(datemonth) [GJCFDateUitil dateToStringByInteger:datemonth]
