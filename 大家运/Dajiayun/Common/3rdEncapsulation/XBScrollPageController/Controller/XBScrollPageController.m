...
//        [cell showBadge];
//        cell.badgeCenterOffset = CGPointMake(-Windows_WIDTH/9, 15);
        ...
        if (self.params.count != 0) {
            if (![cachedViewController valueForKeyPath:@"DJYXBParamdic"]) {
                [cachedViewController setValue:self.params[indexPath.item] forKeyPath:@"DJYXBParamdic"];
            }
