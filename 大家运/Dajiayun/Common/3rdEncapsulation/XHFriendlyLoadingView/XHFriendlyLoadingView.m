...
- (void)_setup {
    ...
    _reloadButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 60, 60)];
    self.reloadButton.alpha = 0.;
    [self.reloadButton setBackgroundImage:[UIImage imageNamed:@"iconfont-p-photo-list-no"] forState:UIControlStateNormal];
