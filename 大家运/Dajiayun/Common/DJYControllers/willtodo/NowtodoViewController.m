...
@interface NowtodoViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation NowtodoViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    cell.statusName.textColor = RGBColor(250, 88, 30);
