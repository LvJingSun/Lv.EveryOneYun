...
#define XWtitlegap 5.0f
#define XWtitleofheigth 20.0f
   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 10, Alertwidth, 20)];
        self.alertTitleLabel.font = [UIFont boldSystemFontOfSize:17.0f];
        self.alertTitleLabel.textColor=AlertTextColor;
        [self addSubview:self.alertTitleLabel];
        
        UILabel *line1 = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.alertTitleLabel.frame) + 5, Alertwidth, 1)];
        
        line1.backgroundColor = [UIColor colorWithRed:161/255. green:161/255. blue:161/255. alpha:1.];
        
        [self addSubview:line1];
        
        CGFloat contentLabelWidth = Alertwidth - 32;
        self.alertContentLabel = [[UILabel alloc] initWithFrame:CGRectMake((Alertwidth - contentLabelWidth) * 0.5, CGRectGetMaxY(self.alertTitleLabel.frame) + 10, contentLabelWidth, 40)];
        ...
        UILabel *line2 = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.alertContentLabel.frame) + 5, Alertwidth, 1)];
        
        line2.backgroundColor = [UIColor colorWithRed:161/255. green:161/255. blue:161/255. alpha:1.];
...
//            leftbtnFrame = CGRectMake((Alertwidth - 2 * XWdoublebuttonWidth - XWbuttonbttomgap) * 0.5, Alertheigth - XWbuttonbttomgap - XWbuttonHeigth, XWdoublebuttonWidth, XWbuttonHeigth);
            ...
            leftbtnFrame = CGRectMake(0, CGRectGetMaxY(line2.frame), (Alertwidth - 1) * 0.5, Alertheigth - CGRectGetMaxY(line2.frame));
...
//            rightbtnFrame = CGRectMake(CGRectGetMaxX(leftbtnFrame) + XWbuttonbttomgap, Alertheigth - XWbuttonbttomgap - XWbuttonHeigth, XWdoublebuttonWidth, XWbuttonHeigth);
            ...
            rightbtnFrame = CGRectMake(CGRectGetMaxX(leftbtnFrame) + 1, CGRectGetMaxY(line2.frame), (Alertwidth - 1) * 0.5, Alertheigth - CGRectGetMaxY(line2.frame));
        ...
        UILabel *line3 = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(leftbtnFrame), CGRectGetMaxY(line2.frame), 1, Alertheigth - CGRectGetMaxY(line2.frame))];
...
//        [self.leftbtn setBackgroundImage:[UIImage imageNamed:@"XW"] forState:UIControlStateNormal];
        ...
        [self.leftbtn setTitleColor:AlertTextColor forState:UIControlStateNormal];
        [self.rightbtn setTitleColor:AlertTextColor forState:UIControlStateNormal];
...
{   //获取第一响应视图视图
    ...
    bjview.backgroundColor = [UIColor colorWithRed:0/255. green:0/255. blue:0/255. alpha:0.4];
